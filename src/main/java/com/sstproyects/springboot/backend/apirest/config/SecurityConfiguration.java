...
import static com.sstproyects.springboot.backend.apirest.user.Permission.ADMIN_CREATE;
import static com.sstproyects.springboot.backend.apirest.user.Permission.ADMIN_DELETE;
import static com.sstproyects.springboot.backend.apirest.user.Permission.ADMIN_READ;
import static com.sstproyects.springboot.backend.apirest.user.Permission.ADMIN_UPDATE;
import static com.sstproyects.springboot.backend.apirest.user.Permission.MANAGER_CREATE;
import static com.sstproyects.springboot.backend.apirest.user.Permission.MANAGER_DELETE;
import static com.sstproyects.springboot.backend.apirest.user.Permission.MANAGER_READ;
import static com.sstproyects.springboot.backend.apirest.user.Permission.MANAGER_UPDATE;
